...
14. Makefile.build脚本分析
    ...
    make xxx_defcondif配置uboot时候如下命令会执行脚本scripts/Makefile.build
    ...
    >     作用是在text中查找符合pattern的部分，如果匹配则用replacement替换掉，返回值为替换后字符串
    >
    >   ```makefile
    ...
    >   ![make_xxx_defconfig](https://github.com/bai779/Study-Log/blob/u-boot/make_xxx_defconfig.png)

15. make过程
    ![make_uboot](https://github.com/bai779/Study-Log/blob/u-boot/make_uboot.png)
